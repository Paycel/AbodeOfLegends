...
public class ShopAdapter extends BaseAdapter {
    ...
    public ShopAdapter(FragmentManager fragmentManager, Context context, Player player, String email){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btn.setText(context.getResources().getText(R.string.upgrade).toString());
